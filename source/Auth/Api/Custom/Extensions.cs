...
namespace Microservices.Auth.Api
{
    public static class Extensions
    {
        ...
        {
            builder.Connection("Server=(localdb)\\MSSQLLocalDB;Database=Microservices.Auth;");
        }
        ...
        {
            builder.UseSqlServer(connectionString, options => options.MigrationsAssembly(Assembly.GetExecutingAssembly().FullName));
        }
    }
}
